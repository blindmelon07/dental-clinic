<x-layouts.guest title="Home">
    ...
    {{-- Hero --}}
    <section class="relative overflow-hidden bg-gradient-to-br from-teal-50 via-cyan-50 to-white">
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <h1 class="mt-4 font-heading text-4xl sm:text-5xl lg:text-6xl font-extrabold text-slate-900 leading-tight">
                        ...
                        <span class="text-teal-600">{{ $settings->hero_subheading ?: 'Start Here' }}</span>
                    </h1>
                    ...
                    <div class="mt-8 flex flex-wrap gap-4">
                        <a href="{{ auth()->check() ? url('/') : route('register') }}"
                           class="inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-teal-600 text-white text-sm font-semibold rounded-xl hover:bg-teal-700 shadow-lg shadow-teal-600/20 transition-all duration-150"
                           wire:navigate>
                        ...
                        <a href="{{ route('services') }}"
                           class="inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-white text-slate-700 text-sm font-semibold rounded-xl border border-slate-200 hover:border-teal-300 hover:text-teal-700 transition-all duration-150"
                           wire:navigate>
                            Our Services
                        </a>
                    </div>
                ...
                <div class="relative"
                    ...
                    <div class="absolute -bottom-6 -left-6 bg-white rounded-2xl shadow-xl p-5 hidden sm:flex items-center gap-4 max-w-xs">
                        <div class="flex items-center justify-center w-12 h-12 rounded-full bg-teal-50 text-teal-600 flex-shrink-0">
            ...
            <div class="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                @forelse ($categories as $category)
                    ...
                    <div class="group bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col">
                        ...
                        {{-- Gradient header --}}
                        <div class="relative bg-gradient-to-br from-teal-500 to-cyan-600 p-8 flex flex-col items-center justify-center">
                            {{-- Icon --}}
                        ...
                        <div class="p-6 flex flex-col flex-1">
                            ...
                            <a href="{{ route('services') }}"
                               class="mt-5 inline-flex items-center justify-between w-full px-4 py-2.5 rounded-xl bg-teal-50 text-teal-700 text-sm font-semibold hover:bg-teal-600 hover:text-white transition-all duration-200 group/btn"
                               wire:navigate>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="mt-8 flex flex-wrap justify-center gap-4">
                ...
                <a href="{{ route('contact') }}"
                   class="inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-teal-700/30 text-white text-sm font-semibold rounded-xl border border-white/30 hover:bg-teal-700/50 transition-all duration-150"
                   wire:navigate>
                    Contact Us
                </a>
            </div>
