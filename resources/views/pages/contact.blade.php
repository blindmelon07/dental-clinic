        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="card text-center">
                    <div class="flex items-center justify-center w-12 h-12 rounded-xl bg-teal-50 text-teal-600 mx-auto mb-4">
            ...
            <div class="grid lg:grid-cols-2 gap-12">
                ...
                <div class="card">
                    ...
                    <form method="POST" action="{{ route('contact.send') }}" class="mt-6 space-y-5">
                        ...
                        <button type="submit"
                                class="inline-flex items-center justify-center gap-2 w-full px-6 py-3.5 bg-teal-600 text-white text-sm font-semibold rounded-xl hover:bg-teal-700 shadow-lg shadow-teal-600/20 transition-all duration-150">
